...
//3. kita dapat menggunakan shell sort, karena shell sort akan membantu elemen yang sudah benar psosisinya, yang dimana ia akan memasukkan insertion sort ke tiap sublist untuk dipindahkan.
//4.
...
void input() {
	while (true) {
		...
		if (n <= 26)
			...
			cout << "\nIaannn06 dapat mempunyai maksimal 26 elemen.\n";
		}
	}
	cout << endl;
	cout << "====================" << endl;
